...
# vendored 改动：原 `from gmssl import sm3, func` 改为内置纯 Python SM3 兼容层，
# 去掉 gmssl 外部依赖（容器内网络常因 MITM 证书装不上）。算法行为完全一致。
from core.douyin.runtime.transport.sign._gmssl_compat import sm3, func
