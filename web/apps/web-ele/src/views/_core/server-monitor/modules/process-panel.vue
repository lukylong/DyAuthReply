    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <ElCard shadow="hover">
        <div class="mb-3 flex items-center gap-2">
          ...
          <span class="text-sm font-medium text-gray-600 dark:text-gray-400"
            >{{ $t('server-monitor.totalProcesses') }}</span
          >
        </div>
        <div class="mb-2 text-3xl font-bold">
          {{ realtimeData?.process_info?.total_processes || 0 }}
        </div>
        <div class="text-sm text-gray-500 dark:text-gray-400">{{ $t('server-monitor.totalSystemProcesses') }}</div>
      </ElCard>
      ...
      <ElCard shadow="hover">
        <div class="mb-3 flex items-center gap-2">
          ...
          <span class="text-sm font-medium text-gray-600 dark:text-gray-400"
            >{{ $t('server-monitor.sleeping') }}</span
          >
        </div>
        <div class="mb-2 text-3xl font-bold">
      ...
      <ElCard shadow="hover">
        <div class="mb-3 flex items-center gap-2">
          ...
          <span class="text-sm font-medium text-gray-600 dark:text-gray-400"
            >{{ $t('server-monitor.otherStatus') }}</span
          >
        </div>
        <div class="mb-2 text-3xl font-bold">
          {{
    ...
    <ElCard shadow="hover">
      <template #header>
        <div class="flex items-center gap-2">
          ...
          <span class="font-semibold">{{ $t('server-monitor.topProcessesCpu') }}</span>
        </div>
      </template>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <ElCard shadow="hover">
        <template #header>
          <div class="flex items-center gap-2">
            <ListTree :size="18" class="text-primary" />
            <span class="font-semibold">{{ $t('server-monitor.processDistribution') }}</span>
          </div>
        </template>
      ...
      <ElCard shadow="hover">
        <template #header>
          <div class="flex items-center gap-2">
            <ListTree :size="18" class="text-primary" />
            <span class="font-semibold">{{ $t('server-monitor.resourceUsageRanking') }}</span>
          </div>
        </template>
