...
import { readFileSync, copyFileSync, mkdirSync, chmodSync, writeFileSync, statSync } from 'node:fs';
...
const destination=join(dir,`dy-agent-${target}${extension}`);copyFileSync(source,destination);chmodSync(destination,0o755);
