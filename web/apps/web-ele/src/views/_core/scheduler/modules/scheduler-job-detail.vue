        ...
        <ElSkeleton :loading="loading" animated>
          ...
          <template #default>
                  ...
                  <div class="mb-2 flex items-center justify-between">
                    ...
                    <ElPopover placement="left" :width="400" trigger="hover">
                      ...
                      <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.executionLogs') }}:</span>
                          <span class="font-medium">{{
                            getStatusText(log.status)
                          }}</span>
                        </div>
                        <div class="flex justify-between">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.startTime') }}:</span>
                          <span class="font-medium">{{
                            log.start_time || '-'
                          }}</span>
                        </div>
                        <div class="flex justify-between">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.endTime') }}:</span>
                          <span class="font-medium">{{
                            log.end_time || '-'
                          }}</span>
                        </div>
                        <div class="flex justify-between">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.duration') }}:</span>
                          <span class="font-medium">{{
                            log.duration ? `${log.duration}s` : '-'
                          }}</span>
                        </div>
                        <div class="flex justify-between">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.retryCount') }}:</span>
                          <span class="font-medium">{{
                            log.retry_count || 0
                          }}</span>
                        </div>
                        ...
                        >
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.executionResult') }}:</span>
                          <div
                        ...
                        <div v-if="log.exception" class="pt-2">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.exceptionInfo') }}:</span>
                          <div
                        ...
                        <div v-if="log.traceback" class="pt-2">
                          <span class="text-gray-600 dark:text-gray-400">{{ $t('scheduler.stackTrace') }}:</span>
                          <div
            ...
            >
              <template v-for="log in logs" :key="log.id">
                ...
                >
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <span class="text-gray-500">{{ $t('scheduler.startTime') }}</span>
                      <span class="font-mono">{{ log.start_time || '-' }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                      <span class="text-gray-500">{{ $t('scheduler.duration') }}</span>
                      <span
                        class="font-mono"
                        :class="
                    ...
                    >
                      <span class="text-gray-500">{{ $t('scheduler.retryCount') }}</span>
            ...
            >
              ...
              <span class="ml-2 text-sm text-gray-500">{{ $t('scheduler.loading') }}</span>
            </div>
