...
function getFormSchema(
  ...
  return [
    ...
    },
    {
      ...
      dependencies: {
        show: (values) => {
          return ['menu', 'online_form', 'online_page'].includes(values.type);
        },
        triggerFields: ['type'],
      },
      fieldName: 'keepAlive',
    ...
    },
    {
      ...
      dependencies: {
        show: (values) => {
          return ['embedded', 'menu', 'online_form', 'online_page'].includes(
            values.type,
          );
        },
        triggerFields: ['type'],
    ...
    if (valid) {
      ...
      switch (data.type) {
        ...
        case 'online_form': {
          ...
          data.component = '_core/form-render/index';

          break;
        }
        case 'online_page': {
          data.query = { pageCode: data.pageCode };
          data.component = '_core/page-render/index';
